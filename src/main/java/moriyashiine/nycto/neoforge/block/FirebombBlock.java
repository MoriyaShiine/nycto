...
public final class FirebombBlock extends BaseFireBlock {
	public static final MapCodec<FirebombBlock> CODEC = simpleCodec(FirebombBlock::new);

	public FirebombBlock(BlockBehaviour.Properties properties) {
		super(properties, 1);
	}
	...
	protected BlockState updateShape(BlockState state, Direction direction, BlockState neighborState, LevelAccessor level, BlockPos pos, BlockPos neighborPos) {
		return state.canSurvive(level, pos) ? defaultBlockState() : Blocks.AIR.defaultBlockState();
	}
