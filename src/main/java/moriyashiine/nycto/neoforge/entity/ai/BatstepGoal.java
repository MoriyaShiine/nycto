...
public final class BatstepGoal extends Goal {
	private final Vampire vampire;

	public BatstepGoal(Vampire vampire) {
	...
	public boolean canUse() {
		...
		return target != null && vampire.canUsePower(NyctoPowers.BATSTEP) && vampire.distanceTo(target) > 6 && vampire.hasLineOfSight(target);
	}
