...
public class VampireArmorModel<S extends BipedEntityRenderState> extends BipedEntityModel<S> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData rightArm = root.addChild(EntityModelPartNames.RIGHT_ARM, ModelPartBuilder.create(), ModelTransform.NONE);
		...
		ModelPartData leftArm = root.addChild(EntityModelPartNames.LEFT_ARM, ModelPartBuilder.create(), ModelTransform.NONE);
