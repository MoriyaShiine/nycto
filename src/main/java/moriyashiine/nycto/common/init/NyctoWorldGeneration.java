...
public class NyctoWorldGeneration {
	...
	public static void bootstrapConfigured(BootstrapContext<ConfiguredFeature<?, ?>> registry) {
		FeatureUtils.register(registry, WILD_GARLIC, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(NyctoBlocks.WILD_GARLIC)));
		FeatureUtils.register(registry, WILD_ACONITE, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(NyctoBlocks.WILD_ACONITE)));
	}
