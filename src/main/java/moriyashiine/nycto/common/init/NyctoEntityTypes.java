...
public class NyctoEntityTypes {
	...
	public static void init() {
		...
		BiomeModifications.addSpawn(BiomeSelectors.tag(NyctoBiomeTags.SPAWNS_VAMPIRES).and(ctx -> ctx.getBiomeKey() != Biomes.PALE_GARDEN), VAMPIRE.getCategory(), VAMPIRE, 30, 1, 1);
