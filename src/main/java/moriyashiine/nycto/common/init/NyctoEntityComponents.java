...
public class NyctoEntityComponents implements EntityComponentInitializer {
	...
	public static final ComponentKey<VampireComponent> VAMPIRE = ComponentRegistry.getOrCreate(Nycto.id("vampire"), VampireComponent.class);
	...
	public void registerEntityComponentFactories(EntityComponentFactoryRegistry registry) {
		registry.registerForPlayers(SYNCED_CONFIG_VALUES, _ -> new SyncedConfigValuesComponent(), RespawnCopyStrategy.ALWAYS_COPY);
		...
		registry.registerForPlayers(VAMPIRE, VampireComponent::new, RespawnCopyStrategy.ALWAYS_COPY);
