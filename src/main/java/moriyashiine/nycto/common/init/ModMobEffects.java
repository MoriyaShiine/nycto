...
public class ModMobEffects {
	...
	public static final Holder<MobEffect> VAMPIRISM = registerMobEffect("vampirism", new TransformationMobEffect(MobEffectCategory.NEUTRAL, 0x7F0000, ModTransformations.HUMAN, ModTransformations.VAMPIRE, ModSoundEvents.GENERIC_TRANSFORM_VAMPIRE));
