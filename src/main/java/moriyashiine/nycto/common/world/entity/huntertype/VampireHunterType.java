...
public class VampireHunterType extends HunterType {
	public VampireHunterType() {
		super(Nycto.id("textures/entity/hunter/vampire_hunter.png"), ResourceKey.create(EquipmentAssets.ROOT_ID, Nycto.id("vampire_hunter")), ModItemTags.VAMPIRE_HUNTER_ARMOR);
	}
