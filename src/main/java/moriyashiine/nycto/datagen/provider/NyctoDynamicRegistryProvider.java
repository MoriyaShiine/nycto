...
public class NyctoDynamicRegistryProvider extends FabricDynamicRegistryProvider {
	public NyctoDynamicRegistryProvider(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture) {
