...
You can sneak right click on valid mobs to feed, but if you'd like to obtain Blood Bottles for portable use, craft a Vampiric Dagger and attack Villagers, Piglins, or other humanoid mobs with it. Once filled, it can be crafted with or right-clicked with Glass Bottles to extract the blood, or automatically extracted if a Glass Bottle is in your offhand.
...
- Dark Form: Transforms you into a hideous beast, granting increased damage, armor, and healing, and allows you to jump in the air. Cannot wear armor or use tools, but can break most blocks by hand. Increases in strength the more weaknesses you have. Costs blood to maintain.
- Haemogenesis: Rapidly regenerates health, removes heal block, and extinguishes you if you're on fire.
- Hypnotize: Forces all nearby mobs to follow and defend you for some time, or briefly stuns them if they're a player. Hypnotized mobs can have their blood sucked without damaging them. Success is dependent on their current health. Removes hypnosis instead when sneaking.
- Keen Senses: Highlights mobs with a color depending on their blood type and shows their health, including those that are invisible or behind walls. Muffles sounds and grants a speed boost while active. Costs blood to maintain.
...
If you'd like to hunt vampires instead, find Wild Garlic in forests and swamps; it is essential for protecting yourself against them.

![Wild Garlic generation](https://github.com/MoriyaShiine/nycto/blob/main/.webassets/wild_garlic.png?raw=true)

Hunters get access to a wide variety of tools. If you want to hunt vampires, these tools include the Garlic Wreath, Garlic-Coated Halberd, and Vampire Hunter armor. Vampires are also weak to various consumable items, such as Wooden Stakes, Garlic Brews, and Firebombs.

![Vampire hunter gear](https://github.com/MoriyaShiine/nycto/blob/main/.webassets/vampire_hunter_gear.png?raw=true)

![Hunter gear](https://github.com/MoriyaShiine/nycto/blob/main/.webassets/hunter_gear.png?raw=true)