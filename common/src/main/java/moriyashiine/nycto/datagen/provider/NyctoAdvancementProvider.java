	...
	public void generateAdvancement(HolderLookup.Provider registries, Consumer<AdvancementHolder> consumer) {
				...
				LootItemEntityPropertyCondition.hasProperties(
						...
						EntityPredicate.Builder.entity()
								...
								.equipment(new EntityEquipmentPredicate.Builder()
										...
										.legs(new ItemPredicate.Builder().of(itemGetter, NyctoItems.VAMPIRE_LEGGINGS))
										.feet(new ItemPredicate.Builder().of(itemGetter, NyctoItems.VAMPIRE_BOOTS))
								)
				).build()));
								...
								LootItemEntityPropertyCondition.hasProperties(
										...
										EntityPredicate.Builder.entity()
												.equipment(EntityEquipmentPredicate.Builder.equipment()
														.mainhand(ItemPredicate.Builder.item().of(itemGetter, NyctoItems.WOODEN_STAKE)))
								).build())),
						vampirePredicate,
						Optional.empty()
				)))
		...
		AdvancementHolder brewGarlicBrew = Advancement.Builder.advancement()
				...
				.addCriterion("brew_garlic_brew", CriteriaTriggers.BREWED_POTION.createCriterion(new BrewedPotionTrigger.TriggerInstance(
						Optional.empty(),
						Optional.of(NyctoPotions.GARLIC)
				)))
				.addCriterion("brew_garlic_brew_long", CriteriaTriggers.BREWED_POTION.createCriterion(new BrewedPotionTrigger.TriggerInstance(
						Optional.empty(),
						Optional.of(NyctoPotions.LONG_GARLIC)
				)))
						...
						Optional.of(
								ItemPredicate.Builder.item()
										...
										.withComponents(DataComponentMatchers.Builder.components()
												.partial(DataComponentPredicates.POTIONS, new PotionsPredicate(HolderSet.direct(NyctoPotions.GARLIC, NyctoPotions.LONG_GARLIC, NyctoPotions.STRONG_GARLIC)))
												.build())
										.build()
						)
				)))
				...
				.addCriterion("wear_vampire_hunter_armor", CriteriaTriggers.INVENTORY_CHANGED.createCriterion(new InventoryChangeTrigger.TriggerInstance(
						Optional.of(ContextAwarePredicate.create(
								LootItemEntityPropertyCondition.hasProperties(
										...
										EntityPredicate.Builder.entity()
												.equipment(new EntityEquipmentPredicate.Builder()
														.head(new ItemPredicate.Builder().of(itemGetter, NyctoItems.VAMPIRE_HUNTER_HELMET))
														.chest(new ItemPredicate.Builder().of(itemGetter, NyctoItems.VAMPIRE_HUNTER_CHESTPLATE))
														.legs(new ItemPredicate.Builder().of(itemGetter, NyctoItems.VAMPIRE_HUNTER_LEGGINGS))
														.feet(new ItemPredicate.Builder().of(itemGetter, NyctoItems.VAMPIRE_HUNTER_BOOTS))
												)
								).build())),
