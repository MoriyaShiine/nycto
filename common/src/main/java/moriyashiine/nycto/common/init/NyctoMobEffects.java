...
public class NyctoMobEffects {
	public static final Holder<MobEffect> VAMPIRISM = registerMobEffect("vampirism", new TransformationMobEffect(MobEffectCategory.NEUTRAL, 0x7F0000, NyctoTransformations.HUMAN, NyctoTransformations.VAMPIRE, NyctoSoundEvents.GENERIC_TRANSFORM_VAMPIRE));
