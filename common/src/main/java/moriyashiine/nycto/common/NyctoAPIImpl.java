...
public class NyctoAPIImpl {
	public static void setTransformation(Player player, Transformation transformation) {
		TransformationComponent transformationComponent = NyctoEntityComponents.TRANSFORMATION.get(player);
	...
	public static void addPower(Player player, Power power) {
		NyctoEntityComponents.TRANSFORMATION.get(player).addPower(new PowerInstance(power));
	}

	public static void removePower(Player player, Power power) {
		NyctoEntityComponents.TRANSFORMATION.get(player).removePower(power);
	}
	...
	public static boolean isPlayerVampire(Entity entity) {
		if (entity instanceof Player player) {
			return NyctoAPI.getTransformation(player) == NyctoTransformations.VAMPIRE;
		}
